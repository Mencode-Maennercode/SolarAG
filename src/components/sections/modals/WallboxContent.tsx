      ...
      <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white p-5 rounded-xl border border-amber-200 shadow-sm relative overflow-hidden">
            <div className="absolute top-0 right-0 w-16 h-16 bg-amber-500/20 rounded-full blur-xl transform translate-x-1/2 -translate-y-1/2"></div>
            <div className="text-amber-700 text-sm mb-1">E-Auto mit PV-Strom (20kWh/100km)</div>
            <div className="text-2xl font-bold text-amber-600 mb-2">ca. 1,60 € *</div>
