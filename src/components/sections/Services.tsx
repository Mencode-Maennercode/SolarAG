...
export default function Services() {
  ...
  return (
    <section id="leistungen" className="py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-amber-500/5 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group bg-white rounded-3xl overflow-hidden shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-500 transform hover:-translate-y-2 border border-slate-100 cursor-pointer flex flex-col"
            ...
            >
              <div className="relative h-64 overflow-hidden shrink-0">
                ...
                <div className="absolute top-6 left-6 z-20 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-lg">
                  <service.icon size={32} className="text-amber-500" />
                </div>
              </div>

              <div className="p-10 flex flex-col flex-grow">
                <h3 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-amber-500 transition-colors">
                  {service.title}
                </h3>
                ...
                <div
                  className="inline-flex items-center gap-2 font-bold text-slate-900 group-hover:text-amber-500 transition-colors group/link mt-auto"
                >
                  Mehr erfahren
